...
public class XssFilterTest {
    ...
    public void test() throws Exception {
        String html = "<html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"view\"><head><style type=\"text/css\">.view{padding:0;word-wrap:break-word;cursor:text;height:90%;}body{margin:8px;font-family:sans-serif;font-size:16px;}p{margin:5px 0;}</style><link rel=\"stylesheet\" type=\"text/css\" href=\"file:///C:/Users/ckwin8/Documents/Tencent Files/598226095/FileRecv/uimaker后台/uimaker后台/js/utf8-jsp/themes/iframe.css\"><style id=\"tablesort\">table.sortEnabled tr.firstRow th,table.sortEnabled tr.firstRow td{padding-right:20px;background-repeat: no-repeat;background-position: center right;   background-image:url(file:///C:/Users/ckwin8/Documents/Tencent%20Files/598226095/FileRecv/uimaker%E5%90%8E%E5%8F%B0/uimaker%E5%90%8E%E5%8F%B0/js/utf8-jsp/themes/default/images/sortable.png);}</style><style id=\"table\">.selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:1px solid #BBB;background-color:#F7F7F7;}table tr.firstRow th{border-top-width:2px;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}</style><style id=\"list\">ol,ul{margin:0;pading:0;width:95%}li{clear:both;}li.list-cn-1-0{background-image:url(http://bs.baidu.com/listicon/list-cn-1-0.gif)}\n" +
                ...
                ".list-paddingleft-3{padding-left:60px}</style><style id=\"pagebreak\">.pagebreak{display:block;clear:both !important;cursor:default !important;width: 100% !important;margin:0;}</style><style id=\"pre\">pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;}</style><style id=\"loading\">.loadingclass{display:inline-block;cursor:default;background: url('file:///C:/Users/ckwin8/Documents/Tencent%20Files/598226095/FileRecv/uimaker%E5%90%8E%E5%8F%B0/uimaker%E5%90%8E%E5%8F%B0/js/utf8-jsp/themes/default/images/loading.gif') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}\n" +
                ".loaderrorclass{display:inline-block;cursor:default;background: url('file:///C:/Users/ckwin8/Documents/Tencent%20Files/598226095/FileRecv/uimaker%E5%90%8E%E5%8F%B0/uimaker%E5%90%8E%E5%8F%B0/js/utf8-jsp/themes/default/images/loaderror.png') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id=\"anchor\">.anchorclass{background: url('file:///C:/Users/ckwin8/Documents/Tencent%20Files/598226095/FileRecv/uimaker%E5%90%8E%E5%8F%B0/uimaker%E5%90%8E%E5%8F%B0/js/utf8-jsp/themes/default/images/anchor.gif') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style></head><body class=\"view\" contenteditable=\"true\" spellcheck=\"false\" style=\"overflow-y: hidden; height: 104px; cursor: text;\"><h1 label=\"标题居左\" style=\"font-size: 32px; font-weight: bold; border-bottom: 2px solid rgb(204, 204, 204); padding: 0px 4px 0px 0px; text-align: left; margin: 0px 0px 10px;\"><span style=\"text-decoration: line-through; font-size: 18px;\">sdaasdsdasds</span></h1></body></html>";


        mvc.perform(get("/test/filter?content=<body></body>"));
        mvc.perform(get("/test/filter?content=<a>www.baidu.com</a>"));
        mvc.perform(get("/test/filter?content=<script>alert('sdf')</script>"));
        mvc.perform(post("/test/filter").param("content",html));
